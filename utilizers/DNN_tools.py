...
def print_and_log_train_one_epoch(i_epoch, run_time, tmp_lr, temp_penalty_bd, pwb, loss_it_tmp,
    ...
    print('solution relative error for training: %.15f\n' % train_res_tmp)
    ...
    log_string('solution relative error for training: %.15f\n' % train_res_tmp, log_out)
...
def print_and_log_test_one_epoch(mse2test, res2test, log_out=None):
    ...
    print('relative error of predict and real for testing: %.15f\n' % res2test)

    log_string('mean square error of predict and real for testing: %.15f' % mse2test, log_out)
    log_string('relative error of predict and real for testing: %.15f\n\n' % res2test, log_out)


def print_log2pre_train_model(log_out=None):
    # 将运行结果打印出来
    print('The results for pre_train model!!!!!!')
    log_string('The results for pre_train model!!!!!!!!', log_out)